...
const aktUpsert = `INSERT INTO akti (id, sektor, area_id, broj, godina, radnja, stupanj, station_id, station_name, watercourse,
	vodostaj_cm, vodostaj_kad, tendencija, prognoza, uvod, zavrsno, poveznice, prekida_akt_id, izvan_snage, rucno, dionice, vrijedi, napomena, potpisnik, primatelji,
	...
	ON CONFLICT(id) DO UPDATE SET sektor = excluded.sektor, area_id = excluded.area_id, broj = excluded.broj, godina = excluded.godina,
		...
		tendencija = excluded.tendencija, prognoza = excluded.prognoza, uvod = excluded.uvod, zavrsno = excluded.zavrsno, poveznice = excluded.poveznice, prekida_akt_id = excluded.prekida_akt_id, izvan_snage = excluded.izvan_snage, rucno = excluded.rucno, dionice = excluded.dionice, vrijedi = excluded.vrijedi,
...
func aktArgs(a *models.Akt) []any {
	...
	return []any{a.ID, a.Sektor, a.AreaID, a.Broj, a.Godina, a.Radnja, string(a.Stupanj), a.StationID, a.StationName, a.Watercourse,
		a.VodostajCm, vodostajKad, a.Tendencija, a.Prognoza, a.Uvod, a.Zavrsno, a.Poveznice, a.PrekidaAktID, a.IzvanSnage, rucno, string(dionice), a.Vrijedi.UTC(), a.Napomena, a.Potpisnik, string(primatelji),
...
func scanAkt(sc interface{ Scan(...any) error }) (models.Akt, error) {
	var a models.Akt
	var stupanj, dionice, primatelji, rucno string
	...
	err := sc.Scan(&a.ID, &a.Sektor, &a.AreaID, &a.Broj, &a.Godina, &a.Radnja, &stupanj, &a.StationID, &a.StationName, &a.Watercourse,
		&vodostaj, &vodostajKad, &a.Tendencija, &a.Prognoza, &a.Uvod, &a.Zavrsno, &a.Poveznice, &a.PrekidaAktID, &a.IzvanSnage, &rucno, &dionice, &a.Vrijedi, &a.Napomena, &a.Potpisnik, &primatelji,
