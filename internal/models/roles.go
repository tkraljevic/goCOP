...
var RoleCatalog = []RoleDef{
	...
	{RoleMainCenterLeader, RoleGroupLevel1, "Voditelj Glavnog centra obrane od poplava", "vodi glavni centar obrane po nalogu glavnog rukovoditelja: u programu radi umjesto njega, piše izvješća i koordinira centre sektora; puna prava"},
	...
	{RoleCopLeader, RoleGroupLevel2, "Voditelj Centra obrane od poplava", "vodi centar obrane po nalogu rukovoditelja sektora: u programu radi umjesto njega, piše izvješća, koordinira područja i djelatnike; upravlja sektorom"},
