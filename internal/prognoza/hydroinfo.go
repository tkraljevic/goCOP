...
var NaseLetve = map[string]string{
	...
	"Dombori":                         "dombori",
	"Mosonmagyaróvár dam, downstream": "mosonmagyarovar-lajta",
	"Szentgotthárd":                   "szentgotthard",
	"Körmend":                         "kormend",
	"Sárvár":                          "sarvar",
	"Ragyogóhíd":                      "ragyogohid",
	"Árpás":                           "arpas",
	"Győr":                            "gyor",
	"Ipolytarnóc":                     "ipolytarnoc",
	"Nógrádszakál":                    "nogradszakal",
	"Balassagyarmat":                  "balassagyarmat",
	"Ipolytölgyes":                    "ipolytolgyes",
	"Zalabér":                         "zalaber",
	"Zalaapáti":                       "zalaapati",
	"Sió floodgate, downstream":       "sio-arvizkapu",
}
